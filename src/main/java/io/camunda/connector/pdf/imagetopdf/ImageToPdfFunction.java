...
public class ImageToPdfFunction implements PdfSubFunction {
    ...
    public PdfOutput executeSubFunction(PdfInput pdfInput, OutboundConnectorContext outboundConnectorContext) throws ConnectorException {
        ...
        try {
            ...
            // ------------------ list of images
            List<Object> listDocSourceReference = pdfInput.getListSourceFile();
            if (listDocSourceReference != null) {
                logger.info("{} Start ImageToPDF {} images to build the PDF [{}]", PdfToolbox.getLogSignature(this),
                        ...
                        destinationFileName);
                for (Object reference : listDocSourceReference) {
                    try {
                        FileVariableReference docSourceReference = FileVariableReference.fromObject(reference);
            ...
            for (FileVariableReference fileVariableReference : listImages) {
                ...
                logger.debug(
                        ...
                        pageNumber,
                        listImages.size(),
                        fileVariable.getName(), timeStep1LoadFileVariable - timeStep0Begin,
                        // Load Image
            ...
            if (destinationStorageDefinition == null && defaultDocSource != null) {
            ...
            if (destinationStorageDefinition == null) {
                ...
                logger.error("{} no destination storage definition define ", PdfToolbox.getLogSignature(this));
