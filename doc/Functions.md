...
| NO_DESTINATION_STORAGE_DEFINITION_DEFINE | No Storage definition is found, please define one                                                                                                |
| ENCRYPTED_PDF_NOT_SUPPORTED              | Encrypted PDF is not supported                                                                                                                   |



## Merge documents
Merge two PDFs document in one PDF


### Inputs
| Name                                   | Description                          | Class            | Level    |
|----------------------------------------|--------------------------------------|------------------|----------|
| listSourceFile                         | List source file                     | java.util.List   | OPTIONAL |
| destinationFileName                    | Destination file name                | java.lang.String | REQUIRED |
| destinationJsonStorageDefinition       | JSon Storage Destination             | java.util.Map    | OPTIONAL |
| destinationStorageDefinition           | Storage Destination                  | java.lang.String | OPTIONAL |
| destinationStorageDefinitionComplement | Storage Destination Complement       | java.lang.String | OPTIONAL |
...
|----------------------------------------|--------------------------------------|------------------|----------|
| sourceFile                             | Source file                          | java.lang.Object | REQUIRED |
| waterMark                              | Watermark                            | java.lang.String | REQUIRED |
| watermarkPosition                      | Position                             | java.lang.String | REQUIRED |
| watermarkColor                         | Color                                | java.lang.String | OPTIONAL |
| watermarkRotation                      | Rotation                             | java.lang.Long   | OPTIONAL |
| watermarkFontHeight                    | Font Height                          | java.lang.Long   | OPTIONAL |
| destinationFileName                    | Destination file name                | java.lang.String | REQUIRED |
| destinationJsonStorageDefinition       | JSon Storage Destination             | java.util.Map    | OPTIONAL |
| destinationStorageDefinition           | Storage Destination                  | java.lang.String | OPTIONAL |
| destinationStorageDefinitionComplement | Storage Destination Complement       | java.lang.String | OPTIONAL |
...
## Image(s) to pdf
From one or a list of image, return a PDF


### Inputs
| Name                                   | Description                          | Class            | Level    |
|----------------------------------------|--------------------------------------|------------------|----------|
| listSourceFile                         | List source file                     | java.util.List   | REQUIRED |
| destinationFileName                    | Destination file name                | java.lang.String | REQUIRED |
| destinationJsonStorageDefinition       | JSon Storage Destination             | java.util.Map    | OPTIONAL |
| destinationStorageDefinition           | Storage Destination                  | java.lang.String | OPTIONAL |
| destinationStorageDefinitionComplement | Storage Destination Complement       | java.lang.String | OPTIONAL |
...
|-----------------------------------|----------------------------------------|
| LOAD_ERROR                        | An error occurs during the load        |
| NO_DESTINATION_STORAGE_DEFINITION | A storage definition must be set       |
| DEFINITION_ERROR                  | Definition error                       |
| LOAD_DOCSOURCE                    | The reference can't be decoded         |
| OPERATION_FAILED                  | An error occurred during the operation |
| DRAW_IMAGE                        | Error during draw the image            |
| ACCESS_SOURCE_IMAGE               | Impossible to access a source image    |



## Pdf to images
Return a list of images, one per page
...
| sourceFile                             | Source file                          | java.lang.Object | REQUIRED |
| extractExpression                      | Extract Expression                   | java.lang.String | REQUIRED |
| dpi                                    | Dpi                                  | java.lang.Long   | OPTIONAL |
| destinationFileName                    | Destination file name                | java.lang.String | REQUIRED |
| destinationJsonStorageDefinition       | JSon Storage Destination             | java.util.Map    | OPTIONAL |
| destinationStorageDefinition           | Storage Destination                  | java.lang.String | OPTIONAL |
| destinationStorageDefinitionComplement | Storage Destination Complement       | java.lang.String | OPTIONAL |
...
| Name                | Description                       | Class          | Level    |
|---------------------|-----------------------------------|----------------|----------|
| listDestinationFile | List of Destination variable name | java.util.List | REQUIRED |
